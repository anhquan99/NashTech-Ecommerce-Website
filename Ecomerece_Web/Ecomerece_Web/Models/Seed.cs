        ...
        public static void SeedProduct(IRepository<Product> service)
        {
            List<Product> data = new List<Product>
            {
                ...
                new Product()
                {
                    ...
                    view = 0,
                    rating = 0,
                    coverImg = "Air-Jordan-3-Retro-'Racer-Blue'-1.jpeg",
                    brand = new Brand(){ brandNameID = "Jordan"},
                ...
                new Product()
                {
                    ...
                    images = new List<Image>()
                    {
                        ...
                        new Image(){ imageNameID = "Yeezy-Boost-350-V2-'Mono-Clay'-1.jpeg" },
                        new Image(){ imageNameID = "Yeezy-Boost-350-V2-'Mono-Clay'-2.jpeg" },
                        new Image(){ imageNameID = "Yeezy-Boost-350-V2-'Mono-Clay'-3.jpeg" },
                        new Image(){ imageNameID = "Yeezy-Boost-350-V2-'Mono-Clay'-4.jpeg" },
                        new Image(){ imageNameID = "Yeezy-Boost-350-V2-'Mono-Clay'-5.jpeg" },
                        new Image(){ imageNameID = "Yeezy-Boost-350-V2-'Mono-Clay'-6.jpeg" },
                        new Image(){ imageNameID = "Yeezy-Boost-350-V2-'Mono-Clay'-7.jpeg" },
                        new Image(){ imageNameID = "Yeezy-Boost-350-V2-'Mono-Clay'-9.jpeg" },
                        new Image(){ imageNameID = "Yeezy-Boost-350-V2-'Mono-Clay'-10.jpeg" },
                        new Image(){ imageNameID = "Yeezy-Boost-350-V2-'Mono-Clay'-11.jpeg" },
                    }
                },
                new Product()
                {
